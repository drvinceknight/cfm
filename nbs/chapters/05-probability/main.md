...
```python
bag = ("Red", "Red", "Red", "Red", "Red", "Blue", "Blue", "Blue", "Blue", "Blue", "Blue", "Blue")
bag
```
...
It is important to include the *docstring* as this allows us to make sure our code is clear. Using Jupyter we can access that docstring in general using `?`:
